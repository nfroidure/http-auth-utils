...
export const parseHTTPHeadersQuotedKeyValueSet = function parseHTTPHeadersQuotedKeyValueSet(contents, authorizedKeys, requiredKeys = []) {
...
export const buildHTTPHeadersQuotedKeyValueSet = function buildHTTPHeadersQuotedKeyValueSet(data, authorizedKeys, requiredKeys = []) {
